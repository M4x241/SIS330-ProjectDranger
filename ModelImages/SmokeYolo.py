...
PATH_PESOS_ENTRENADOS = '/home/ghost/Documents/Proyectos/python/runs/detect/train/weights/best.pt'

# 2. Ruta a la imagen de tu entorno Unity que quieres probar
# Puedes usar una captura de pantalla fresca de Dranger/Martijn.
PATH_IMAGEN_PRUEBA = '/home/ghost/Documents/Proyectos/python/Proyecto Python/Servidor/Smoke-6617-_jpg.rf.e4d52458c4acfa0bccf03ebbe0669b1d.jpg'
# ---------------------
...
def probar_deteccion():
    ...
    for r in results:
        ...
        # Intentar mostrar en ventana (requiere XWayland o export QT_QPA_PLATFORM=xcb)
        print("Intentando abrir ventana de visualización...")
        print("Presiona cualquier tecla SOBRE LA IMAGEN para cerrar.")
        cv2.imshow("Prueba de Modelo de Humo Especializado", im_array)
        cv2.waitKey(0)
