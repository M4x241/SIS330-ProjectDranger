...
def entrenar_modelo():
    ...
    results = model.train(
        ...
        # --- Configuración para Datasets Pequeños (Augmentation) ---
        mosaic=1.0,        # Mezcla 4 imágenes para crear escenas complejas
        mixup=0.1,         # Ayuda a detectar humo semitransparente
